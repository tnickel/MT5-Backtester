...
public class WorkflowView {
    ...
    private final ExpressStrategyDetailDialog.JavaBridge javaBridge;
    ...
    public WorkflowView(LogView globalLogView) {
        ...
        this.javaBridge = new ExpressStrategyDetailDialog.JavaBridge(
                engine,
                () -> root.getScene() != null ? root.getScene().getWindow() : null,
                () -> resultsTable != null ? new ArrayList<>(resultsTable.getItems()) : List.of(),
                () -> root.getScene() != null ? root.getScene().getStylesheets() : List.of(),
                msg -> logToConsole("BRIDGE", msg)
        );
    ...
    private TabPane createBottomTabPane() {
        ...
        resultsTable = ExpressResultsTableFactory.createResultsTable(
                engine,
                this::showStrategyDetailDialog,
    ...
    private void showStrategyDetailDialog(CombinedPass cp) {
        ...
        Collection<String> sheets = root.getScene() != null ? root.getScene().getStylesheets() : List.of();
        List<CombinedPass> passes = resultsTable != null ? new ArrayList<>(resultsTable.getItems()) : List.of();
    ...
    private void runSingleBacktest(CombinedPass cp, boolean visual) {
        Window owner = root.getScene() != null ? root.getScene().getWindow() : null;
        Collection<String> sheets = root.getScene() != null ? root.getScene().getStylesheets() : List.of();
        SingleBacktestHelper.runExpressWorkflowBacktest(
                cp, visual, engine, owner, sheets,
                dir -> SingleBacktestHelper.openReport(dir, msg -> logToConsole("ERROR", msg))
        );
    }
